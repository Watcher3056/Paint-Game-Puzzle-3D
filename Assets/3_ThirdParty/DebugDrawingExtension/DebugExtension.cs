...
public static class DebugExtension
{
	...
	/// 	- The color of the arrow.
	/// </param>
	public static void DrawArrow(Vector3 position, Vector3 direction, Color color, float coneSize = 0.333f, bool constConeSize = false)
	{	
		Color oldColor = Gizmos.color;
		Gizmos.color = color;
		
		Gizmos.DrawRay(position, direction);
		DebugExtension.DrawCone(position+direction, constConeSize ? coneSize * -direction.normalized : (-direction * coneSize), color, 15);
