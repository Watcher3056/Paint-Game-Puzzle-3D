...
namespace Sirenix.OdinValidator.Editor
{
    ...
    public class ValidationProfileEditor
    {
        ...
        [Title("$targetTitle", "$targetSubtitle"), ShowIf("selectedSourceTarget", Animate = false), DisableContextMenu, InlineEditor(InlineEditorObjectFieldModes.CompletelyHidden), SuppressInvalidAttributeError, ShowInInspector, HideReferenceObjectPicker]
